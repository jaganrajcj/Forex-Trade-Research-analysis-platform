...
const UpdateTrade = ({ modalOpen, handleModalClose, setTrades, setSnackbar, trade }) => {
                        ...
                        <ul className="flex flex-col gap-5 p-0">
                            <li className="flex items-center justify-between gap-4 w-[100%]">
                                ...
                                <Input type="date" label="date" error={errors?.date}
                                    defaultValue={moment(new Date(trade.date)).format('YYYY-MM-DD')}
                                ...
                                <Input label="Entry Price" type="number"
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (parseInt(e.target.value) > 0) {
                                            ...
                                            setTradeData({ ...tradeData, entry: parseInt(e.target.value) });
                                        }
                                        else {
                            ...
                            <li className="flex items-center justify-between gap-4 w-[100%]">
                                ...
                                <Select label="Trade Direction"
                                    // defaultValue={trade?.direction || null}
                                    onChange={(e) =>
                                        setTradeData({ ...tradeData, direction: e })}>
                        ...
                        <ul className="flex flex-col gap-4 p-0">
                            <li className="flex items-center justify-between gap-4 w-[100%]">
                                ...
                                <Input label="Account Balance"
                                    ...
                                    // disabled
                                    defaultValue={trade.balance || null}
                            ...
                            <li className="flex items-center justify-between gap-4 w-[100%]">
                                ...
                                <Input label="Target Price"
                                    ...
                                    defaultValue={trade?.target || null}
                                    onChange={(e) => {
                                        // console.log(typeof e.target.value)
                                        if (parseFloat(e.target.value) > 0) {
                        ...
                        <ul className="flex flex-col gap-4 p-0 ">
                            ...
                            <li className="flex items-center justify-between gap-4 w-[100%]">
                                ...
                                <Input label="Closed P&L"
                                    defaultValue={trade?.closedPnl || null}
                                ...
                                <div className="flex justify-end gap-4 w-[100%] px-4">
                                    ...
                                    <Button variant='gradient' onClick={() => {
                                        if (Object.keys(tradeData).length == 11) {
                                            ...
                                            if (!isError) journal.updateTrade(userData, tradeData, trade.id).then((res) => {
